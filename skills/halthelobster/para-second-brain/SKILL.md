...
PARA is a knowledge organization system created by [Tiago Forte](https://fortelabs.com/), author of _Building a Second Brain_. It organizes everything into four categories based on actionability:
...
_Pairs well with [memory-setup](https://clawdhub.com/jrbobbyhansen-pixel/memory-setup) for technical config and [proactive-agent](https://clawdhub.com/halthelobster/proactive-agent) for behavioral patterns._
