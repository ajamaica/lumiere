...
async function getOfflineQuote() {
  const quotes = [
    ...
    {
      character: 'Michael Scott',
      content: 'I love inside jokes. Love to be a part of one someday.',
    },
    {
      character: 'Michael Scott',
      content: 'Fool me once, strike one. Fool me twice, strike three.',
    },
    {
      character: 'Michael Scott',
      content:
    ...
    {
      character: 'Michael Scott',
      content: "You miss 100 percent of the shots you don't take. Wayne Gretzky.",
    },
    ...
    { character: 'Kevin Malone', content: 'Why waste time say lot word when few word do trick?' },
    {
      ...
      content:
        "I'm not gaining anything from this seminar. I'm a professional woman. The head of accounting. I'm in the healthiest relationship of my life.",
    },
    { character: 'Kelly Kapoor', content: "I talk a lot, so I've learned to tune myself out." },
    {
      character: 'Oscar Martinez',
      content: 'Saddle Shoes With Denim? I Will Literally Call Protective Services.',
    },
  ]
