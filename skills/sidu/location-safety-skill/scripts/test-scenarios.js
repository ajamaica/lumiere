...
const scenarios = {
    ...
    alerts: [
      {
        ...
        description:
          'This is a TEST alert. A severe thunderstorm is approaching your area with 60mph winds and quarter-size hail.',
  ...
  memory: {
    ...
    ok: false,
    alerts: [
      { type: 'memory', severity: 'warning', message: 'TEST: Memory getting low: 25% free' },
    ],
  },
}
