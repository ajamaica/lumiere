...
metadata:
  {
    'clawdbot':
      {
        'emoji': '🎯',
        'requires': { 'bins': ['gh'], 'optional': ['bird'] },
        'config': ['solobuddy.dataPath', 'solobuddy.voice'],
      },
  }
---
...
[
  [
    { "text": "📋 Ideas", "callback_data": "sb:backlog" },
    { "text": "✍️ Drafts", "callback_data": "sb:drafts" }
  ],
...
[
  [
    { "text": "1️⃣", "callback_data": "sb:generate:1" },
    { "text": "2️⃣", "callback_data": "sb:generate:2" },
    { "text": "3️⃣", "callback_data": "sb:generate:3" }
  ],
