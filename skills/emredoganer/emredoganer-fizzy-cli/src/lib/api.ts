...
import { getCurrentAccountSlug, getToken } from './config.js'
...
export async function createColumn(
  ...
  const client = await createClient()
  const response = await client
    .post(`boards/${boardSlug}/columns.json`, {
...
export async function updateColumn(
  ...
  const client = await createClient()
  const response = await client
    .patch(`boards/${boardSlug}/columns/${columnId}.json`, {
      json: { column: updates },
    })
    .json<FizzyColumn>()
  return response
...
export async function listCards(
  ...
  const response = await client
    .get(`boards/${boardSlug}/cards.json${queryString}`)
    .json<FizzyCard[]>()
  return response
}
...
export async function getCard(boardSlug: string, cardNumber: number): Promise<FizzyCard> {
  const client = await createClient()
  const response = await client
    .get(`boards/${boardSlug}/cards/${cardNumber}.json`)
    .json<FizzyCard>()
  return response
}
...
export async function createCard(
  ...
  const client = await createClient()
  const response = await client
    .post(`boards/${boardSlug}/cards.json`, {
...
export async function updateCard(
  ...
  const client = await createClient()
  const response = await client
    .patch(`boards/${boardSlug}/cards/${cardNumber}.json`, {
      json: { card: updates },
    })
    .json<FizzyCard>()
  return response
...
export async function closeCard(boardSlug: string, cardNumber: number): Promise<FizzyCard> {
  const client = await createClient()
  const response = await client
    .post(`boards/${boardSlug}/cards/${cardNumber}/close.json`)
    .json<FizzyCard>()
  return response
}
...
export async function reopenCard(boardSlug: string, cardNumber: number): Promise<FizzyCard> {
  const client = await createClient()
  const response = await client
    .post(`boards/${boardSlug}/cards/${cardNumber}/reopen.json`)
    .json<FizzyCard>()
  return response
}
...
export async function moveCard(
  ...
  const client = await createClient()
  const response = await client
    .post(`boards/${boardSlug}/cards/${cardNumber}/move.json`, {
...
export async function assignCard(
  ...
  const client = await createClient()
  const response = await client
    .post(`boards/${boardSlug}/cards/${cardNumber}/assign.json`, {
...
export async function unassignCard(
  ...
  const client = await createClient()
  const response = await client
    .post(`boards/${boardSlug}/cards/${cardNumber}/unassign.json`, {
      json: { assignee_ids: assigneeIds },
    })
    .json<FizzyCard>()
  return response
...
export async function tagCard(
  ...
  const client = await createClient()
  const response = await client
    .post(`boards/${boardSlug}/cards/${cardNumber}/tag.json`, {
      json: { tag_ids: tagIds },
    })
    .json<FizzyCard>()
  return response
...
export async function setNotNow(
  boardSlug: string,
  cardNumber: number,
  notNow: boolean,
): Promise<FizzyCard> {
...
export async function listSteps(boardSlug: string, cardNumber: number): Promise<FizzyStep[]> {
  const client = await createClient()
  const response = await client
    .get(`boards/${boardSlug}/cards/${cardNumber}/steps.json`)
    .json<FizzyStep[]>()
  return response
}
...
export async function addStep(
  ...
  const client = await createClient()
  const response = await client
    .post(`boards/${boardSlug}/cards/${cardNumber}/steps.json`, {
      json: { step: { content } },
    })
    .json<FizzyStep>()
  return response
...
export async function completeStep(
  ...
  const client = await createClient()
  const response = await client
    .post(`boards/${boardSlug}/cards/${cardNumber}/steps/${stepId}/complete.json`)
    .json<FizzyStep>()
  return response
}
...
export async function uncompleteStep(
  ...
  const client = await createClient()
  const response = await client
    .post(`boards/${boardSlug}/cards/${cardNumber}/steps/${stepId}/uncomplete.json`)
    .json<FizzyStep>()
  return response
}
...
export async function listComments(boardSlug: string, cardNumber: number): Promise<FizzyComment[]> {
  const client = await createClient()
  const response = await client
    .get(`boards/${boardSlug}/cards/${cardNumber}/comments.json`)
    .json<FizzyComment[]>()
  return response
}
...
export async function addComment(
  ...
  const client = await createClient()
  const response = await client
    .post(`boards/${boardSlug}/cards/${cardNumber}/comments.json`, {
...
export async function updateComment(
  ...
  const client = await createClient()
  const response = await client
    .patch(`boards/${boardSlug}/cards/${cardNumber}/comments/${commentId}.json`, {
      json: { comment: { content } },
    })
    .json<FizzyComment>()
  return response
