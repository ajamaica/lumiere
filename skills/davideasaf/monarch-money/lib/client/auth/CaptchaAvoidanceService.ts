...
export class CaptchaAvoidanceService {
  ...
  recordCaptchaEncounter(): void {
    ...
    console.warn(
      `🚫 CAPTCHA encountered. Increasing rate limit backoff to ${this.backoffMultiplier}x`,
    )
  }
  ...
  getStatus(): {
    ...
    return {
      ...
      canAuthenticate:
        timeSinceLastAuth >= minTimeBetweenAuth &&
        this.recentAuthAttempts.length < this.maxAuthAttemptsPerHour,
    }
  }
