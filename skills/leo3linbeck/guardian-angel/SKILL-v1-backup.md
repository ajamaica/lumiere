...
_How clear is the moral evaluation of this action?_
...
_How significant are the potential consequences?_
...
This skill implements _external_ moral evaluation. For _conscience formation_, the user should:
...
_"Good requires the integrity of all elements; evil results from any single defect."_
...
_"Prudence is right reason applied to action." — St. Thomas Aquinas, ST II-II, Q.47, a.2_
