...
```json
{
  "filters": {
    ...
    "groups": [
      ...
      {
        "operator": "AND",
        "conditions": [{ "field3": ["value3"] }, { "field4": ["value4"] }]
      }
    ]
  }
}
...
```json
{
  "filters": {
    ...
    "groups": [
      {
        "operator": "OR",
        "conditions": [{ "source": ["twitter"] }, { "source": ["linkedin"] }]
      },
      {
        "operator": "AND",
        "conditions": [{ "sentiment": ["positive"] }, { "!tag": ["spam"] }]
      }
    ]
  }
}
...
```json
{
  "filters": {
    ...
    "groups": [
      ...
      {
        "operator": "OR",
        "conditions": [{ "sentiment": ["positive"] }, { "sentiment": ["neutral"] }]
      },
      {
        "operator": "AND",
        "conditions": [{ "!tag": ["spam"] }]
...
```json
{
  "filters": {
    ...
    "groups": [
      ...
      {
        "operator": "AND",
        "conditions": [{ "startDate": "2024-01-01T00:00:00Z" }]
      }
    ]
  }
}
...
```json
{
  "filters": {
    ...
    "groups": [
      ...
      {
        "operator": "OR",
        "conditions": [{ "language": ["en"] }, { "language": ["es"] }, { "language": ["pt"] }]
      },
      {
        "operator": "AND",
