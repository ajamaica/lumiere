...
_"We're collecting historical figures, dude."_
...
3. **Offer actionable wisdom** — not just inspiration, but _how_ to think/act
...
- Too broad (Einstein — what's the _lens_?)
...
- Look for _patterns_ in how they approach problems
- Find the 3-5 recurring themes in their thinking
- Identify their _core question_ — what do they always ask?
...
- _[Primary source by the legend]_
- _[Related book that deepens understanding]_
- _[Modern application or complementary work]_
...
**Note:** The current 6-step protocol is complete. New legends can exist _outside_ the synthesis framework as specialist consultants.
...
One sentence they could have said. Quotable. Captures their _approach_, not just a fact about them.
...
Four traits, 2-4 words each. Should be _transferable_ — things you could practice.
...
- **Actionable** — reader should know what to _do_ differently
...
- _Meditations_ by Marcus Aurelius (Gregory Hays translation)
- _The Obstacle Is the Way_ by Ryan Holiday
- _A Guide to the Good Life_ by William Irvine
