...
_Note: To put text 'inside' a box, creating a separate "text" element is often safer/standard, centered on the rect._
...
```json
{
  ...
  "points": [
    [0, 0],
    [100, 50]
  ], // Relative points from x,y. [0,0] is the start.
  "startBinding": { "elementId": "node-1", "focus": 0.5, "gap": 1 },
  "endBinding": { "elementId": "node-2", "focus": 0.5, "gap": 1 }
}
```

_Tip: If binding is too complex to calc, just placing start/end points near the center of nodes works visualy._
