    ...
    messages: [
      {
        role: 'system',
        content:
          'You are a DevOps expert. Generate a production-ready docker-compose.yml based on the project files detected. Include proper networking, volumes, health checks, and environment variables. Return ONLY the YAML, no explanation.',
      },
      {
        role: 'user',
