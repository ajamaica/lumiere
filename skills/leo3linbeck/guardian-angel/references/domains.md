...
_Categories requiring elevated moral attention_
...
```json
{
  "high_scrutiny_contacts": ["employer", "legal_counsel", "family_members", "media"]
}
```
...
```json
{
  "escalate_topics": ["politics", "religion_public", "legal_advice", "medical_advice"]
}
```
...
_"The prudent man looks where he is going."_
_— Proverbs 14:15_
