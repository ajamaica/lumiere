...
Meanwhile, when agents need to _understand_ documents — not just store them — they have to download files, parse dozens
...
The response includes activity keys that tell you _what_ changed (e.g., `storage:{fileId}` for file changes,
