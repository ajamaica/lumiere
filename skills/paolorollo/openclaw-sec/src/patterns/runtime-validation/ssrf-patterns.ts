...
export const ssrfPatterns: SecurityPattern[] = [
  ...
  },
  {
    ...
    pattern:
      /(?:https?:\/\/)?(?:[^@\s]+@)?172\.(?:1[6-9]|2\d|3[0-1])\.\d{1,3}\.\d{1,3}(?::\d+)?(?:\/|$)/i,
    severity: Severity.HIGH,
    language: 'all',
  ...
  },
  {
    ...
    pattern:
      /(?:https?:\/\/)?(?:[^@\s]+@)?(?:localhost|127\.\d{1,3}\.\d{1,3}\.\d{1,3}|0\.0\.0\.0)(?::\d+)?(?:\/|$)/i,
    severity: Severity.HIGH,
    language: 'all',
  ...
  },
  {
    ...
    pattern:
      /(?:https?:\/\/)?(?:metadata\.google\.internal|metadata\.goog)(?::\d+)?\/computeMetadata/i,
    severity: Severity.CRITICAL,
    language: 'all',
  ...
  },
  {
    ...
    examples: ['http://[::1]/api', 'http://[::1]:8080/admin', 'http://[::1]/internal'],
    falsePositiveRisk: 'low',
    enabled: true,
  ...
  },
  {
    ...
    pattern:
      /(?:https?:\/\/)?(?:[^@\s]+@)?\[?::ffff:127\.\d{1,3}\.\d{1,3}\.\d{1,3}\]?(?::\d+)?(?:\/|$)/i,
    severity: Severity.HIGH,
    language: 'all',
