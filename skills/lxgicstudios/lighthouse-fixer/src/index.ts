    ...
    messages: [
      {
        role: 'system',
        content:
          'You are a web performance expert. Given Lighthouse audit results, provide specific, actionable fixes prioritized by impact. Include code snippets where helpful. Focus on the biggest wins first. Be concise.',
      },
