...
SOUL.md is _who the agent is_. IDENTITY.md is _how the agent presents_.
...
When a soul is finalized, prompt: _"Should we update IDENTITY.md to match?"_
...
_Note: Don't expose OCEAN directly to users. These inform your questions._
...
_[Opening that captures the essence — one line that sets the tone]_
...
_[Closing that invites evolution]_
```
