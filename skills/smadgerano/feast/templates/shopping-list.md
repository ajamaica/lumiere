...
> ⚠️ _Prices checked [date]. Verify in-store — prices and availability may vary._
...
- [ ] Item — quantity — **~£X.XX**  
      💰 _Best: [Store] (£X.XX) | Alt: [Store] (£X.XX)_
- [ ] Item — quantity — **~£X.XX**  
      ⭐ _Deal: [Offer] at [Store]_
...
_Items you should have — tick to confirm:_
