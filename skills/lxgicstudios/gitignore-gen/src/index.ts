    ...
    messages: [
      {
        role: 'system',
        content:
          'You are a .gitignore expert. Given a list of project files and directories, generate a comprehensive .gitignore file. Only output the .gitignore contents, no explanations. Include comments for each section.',
      },
      {
        role: 'user',
