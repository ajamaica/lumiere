  ...
  },
  {
    ...
    message: {
      ...
      content: [
        ...
        { type: 'toolCall', id: 'toolu_123', name: 'exec', arguments: { command: 'ls' } },
      ],
      stopReason: 'toolUse',
    },
  },
...
const ORPHAN_ONLY_SESSION = [
  ...
  // Orphaned tool result with no matching tool call at all
  {
    ...
    message: {
      role: 'toolResult',
      toolCallId: 'toolu_nonexistent',
      content: [{ type: 'text', text: 'phantom result' }],
    },
  },
  {
    type: 'message',
