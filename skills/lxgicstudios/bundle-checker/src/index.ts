    ...
    messages: [
      {
        role: 'system',
        content:
          "You are a frontend performance expert. Analyze the project's dependencies and build config to identify bundle size issues. Suggest specific fixes: tree-shaking opportunities, lighter alternatives, dynamic imports, and config changes. Estimate potential savings. Be concise and actionable.",
      },
