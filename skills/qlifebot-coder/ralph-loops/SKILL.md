...
100000. Important: Single sources of truth, no migrations.

100001. Create git tags after successful builds.

100002. Add logging if needed to debug.

100003. Keep IMPLEMENTATION_PLAN.md current.
```
