 ...
 */
export function mergeSessions(localSessions: Session[], remoteSessions: Session[]): Session[] {
  ...
  localSessions.sort((a, b) => new Date(b.lastUpdate).getTime() - new Date(a.lastUpdate).getTime())
