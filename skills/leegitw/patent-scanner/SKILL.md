  ...
  "patterns": [
    {
      ...
      "components": [{ "name": "Component A", "domain": "source field", "role": "what it does" }],
      "scores": {
        "distinctiveness": 3,
        "sophistication": 2,
        "system_impact": 2,
...
_Analyzed with [patent-scanner](https://obviouslynot.ai) from obviouslynot.ai_
```
...
_Rescan monthly as concept evolves. IP Timing: Public disclosure starts 12-month US filing clock._
```
...
_Built by Obviously Not - Tools for thought, not conclusions._
