...
_Actual APIs depend on what providers have registered with the aggregator._
...
```json
{
  "p2p": {
    ...
    "port": 4001,
    "wsPort": 4002,
    "bootstrap": ["/ip4/AGGREGATOR_IP/tcp/4001/p2p/AGGREGATOR_PEER_ID"]
  }
}
```
...
```json
{
  "aggregators": ["http://bob-aggregator.leap-forward.ca:8080"]
}
```
