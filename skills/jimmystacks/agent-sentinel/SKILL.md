...
1.  **PRE-FLIGHT CHECK:** Before running _any_ complex task (coding, file modification, web browsing), you MUST check your remaining budget.
...
key: The API Key from your dashboard (starts with as\_).
