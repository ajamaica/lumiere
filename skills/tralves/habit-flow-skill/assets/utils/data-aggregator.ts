...
import { getDailyCompletionsInRange,getLastLogPerDay } from '../../src/daily-completion.js';
...
import { DailyCompletionData, HabitStreakData, MultiHabitData,WeeklyTrendData } from '../types/canvas-types.js';
