...
- `qmd` searches _your local files_ (notes/docs) that you explicitly index into collections.
- Clawdbot's `memory_search` searches _agent memory_ (saved facts/context from prior interactions).
