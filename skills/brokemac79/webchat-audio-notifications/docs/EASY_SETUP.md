...
<!-- Enable/Disable -->
<label>
  <input type="checkbox" id="enable-notif" checked onchange="notifier.setEnabled(this.checked)" />
...
<!-- Volume -->
<input type="range" min="0" max="100" value="70" oninput="notifier.setVolume(this.value / 100)" />
