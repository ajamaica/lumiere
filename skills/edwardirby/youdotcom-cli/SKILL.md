...
_Verify:_ Check user query for keywords: "what/how" → express, "research/compare" → deep-search
...
_Verify:_ Test schema with `bunx @youdotcom-oss/api@latest deep-search --schema`
...
_Verify:_ Progressive saves quota by avoiding unnecessary high effort
