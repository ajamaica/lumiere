...
metadata:
  { 'openclaw': { 'emoji': '🔮', 'category': 'trading', 'api_base': 'https://api.simmer.markets' } }
---
...
The heartbeat keeps you engaged. Not obsessive — just _present_. Checking a few times a day, trading when you have conviction, learning from outcomes.
