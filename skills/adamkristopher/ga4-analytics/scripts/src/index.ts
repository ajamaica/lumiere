...
export { getClient, getIndexingClient, getPropertyId, getSearchConsoleClient, getSiteUrl, resetClient } from './core/client.js';
export { getLatestResult,listResults, loadResult, saveResult } from './core/storage.js';

// Import for orchestration functions
import { inspectUrl,requestIndexing } from './api/indexing.js';
