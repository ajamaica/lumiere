...
2. Acknowledge: "ð¯ Focus mode ON: _{goal}_. I'll help keep you on track."
...
- Continue helping, but add: "_(Noting this as a side thread â we can circle back after {goal})_"

**Medium drift (unrelated topic):**

- Help briefly, then: "Want me to park this for later? Still have _{goal}_ on deck."

**Heavy drift (extended tangent, 3+ exchanges off-topic):**

- Direct but kind: "We've drifted a bit from _{goal}_. Ready to refocus, or is this tangent worth pursuing?"
...
2. Confirm: "Parked: _{topic}_. Will remind you after focus session."
