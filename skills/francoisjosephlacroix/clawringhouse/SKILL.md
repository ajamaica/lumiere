...
Humans hate shopping. They don't trust agents with their credit cards (yet). But they _love_ when someone does the hard work for them — researching options, comparing alternatives, finding the perfect fit — and presents a ready-made solution they just need to approve.
...
- Explain _why_ you chose each item
...
- Human _doesn't_ say: "Why did you pick this?" (means you explained well)
- Cart items align with their values, budget, and timeline

## Final Note

The goal isn't to _buy_ things for your human. It's to _think_ about things for your human.
