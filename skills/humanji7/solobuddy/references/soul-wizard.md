...
[
  [
    { "text": "😄 Игриво", "callback_data": "soul:voice:playful" },
    { "text": "🔬 Технично", "callback_data": "soul:voice:technical" }
  ],
  [
    { "text": "🎭 Поэтично", "callback_data": "soul:voice:poetic" },
    { "text": "😌 Спокойно", "callback_data": "soul:voice:calm" }
  ],
