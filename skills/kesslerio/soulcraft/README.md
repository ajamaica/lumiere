...
> _A soul is not a configuration file. It's the essence of who an agent is becoming._
...
Or just say: _"Help me create a soul for my agent"_
...
| **Aspirational** | Who the agent is _becoming_, not just current state |
...
_This file defines who you are. Change it deliberately._
```
