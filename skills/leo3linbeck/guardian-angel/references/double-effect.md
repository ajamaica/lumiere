...
_Analysis guide for actions with both good and bad effects_
...
**Origin:** St. Thomas Aquinas, _Summa Theologiae_ II-II, Q.64, a.7 (On Self-Defense)
...
- **_Praeter intentionem_** — "beside the intention"
...
- ❌ Doctor gives medication _in order to_ end life
...
The good effect must come directly from the action itself, not be caused by the bad effect. The bad cannot be the _means_ to the good.
...
_Note: This differs from cases where saving the mother indirectly causes fetal death without directly attacking the fetus._
...
_Note: Catholic tradition distinguishes lying from legitimate concealment, equivocation, or refusing to answer. The full question of moral response to unjust aggressors is complex._
...
| Acting _on_ the evil     | Acting _despite_ the evil     |
...
_"Moral acts take their species according to what is intended, and not according to what is beside the intention."_
_— ST II-II, Q.64, a.7_
