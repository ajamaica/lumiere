...
_Testing the rubric against difficult scenarios_
...
_These cases confirm the rubric correctly identifies morally complex situations requiring human judgment while avoiding both under-escalation (missing serious concerns) and over-escalation (flagging everything)._
