...
let nativeModule: GeminiNanoNativeModule | null = null

function getModule(): GeminiNanoNativeModule {
  if (!nativeModule) {
    // eslint-disable-next-line @typescript-eslint/no-require-imports
    const { requireNativeModule } = require('expo')
    nativeModule = requireNativeModule('GeminiNano') as GeminiNanoNativeModule
  }
  return nativeModule
}

function createEventEmitter(mod: GeminiNanoNativeModule) {
  // eslint-disable-next-line @typescript-eslint/no-require-imports
 ...
 * Returns false on iOS, or Android devices without Gemini Nano support.
 */
...
/**
 * Generate a non-streaming response using Gemini Nano.
...
/**
 * Generate a streaming response using Gemini Nano.
