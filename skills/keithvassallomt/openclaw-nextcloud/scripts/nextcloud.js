      ...
      var weekStartsOn = (0, _index2.default)(
        (_ref =
          (_ref2 =
            ...
            ? _ref2
            : (_defaultOptions$local = defaultOptions3.locale) === null ||
...
var require_constants = __commonJS({
  'node_modules/date-fns/constants/index.js'(exports2) {
    ...
    exports2.secondsInYear =
      exports2.secondsInWeek =
      exports2.secondsInQuarter =
      exports2.secondsInMonth =
      exports2.secondsInMinute =
      exports2.secondsInHour =
      exports2.secondsInDay =
      exports2.quartersInYear =
      exports2.monthsInYear =
      exports2.monthsInQuarter =
      exports2.minutesInHour =
      exports2.minTime =
      exports2.millisecondsInSecond =
      exports2.millisecondsInMinute =
      exports2.millisecondsInHour =
      exports2.maxTime =
      exports2.daysInYear =
      exports2.daysInWeek =
        void 0
        ...
        (_ref =
          (_ref2 =
            (_ref3 =
              ...
              ? _ref3
              : defaultOptions3.firstWeekContainsDate) !== null && _ref2 !== void 0
            ? _ref2
            : (_defaultOptions$local = defaultOptions3.locale) === null ||
                _defaultOptions$local === void 0
              ? void 0
      ...
      var locale =
        (_ref =
          (_options$locale = options === null || options === void 0 ? void 0 : options.locale) !==
            ...
            ? _options$locale
            : defaultOptions3.locale) !== null && _ref !== void 0
          ? _ref
          : _index11.default
        ...
        (_ref2 =
          (_ref3 =
            (_ref4 =
              ...
              ? _ref4
              : defaultOptions3.firstWeekContainsDate) !== null && _ref3 !== void 0
            ? _ref3
            : (_defaultOptions$local = defaultOptions3.locale) === null ||
                _defaultOptions$local === void 0
              ? void 0
        ...
        (_ref5 =
          (_ref6 =
            (_ref7 =
              ...
              ? _ref7
              : defaultOptions3.weekStartsOn) !== null && _ref6 !== void 0
            ? _ref6
            : (_defaultOptions$local3 = defaultOptions3.locale) === null ||
    ...
    function formatDuration(duration, options) {
      ...
      var locale =
        (_ref =
          ...
          : _index2.default
      var format2 =
        (_options$format = options === null || options === void 0 ? void 0 : options.format) !==
      ...
      var delimiter =
        (_options$delimiter =
          options === null || options === void 0 ? void 0 : options.delimiter) !== null &&
        ...
        (_ref2 =
          (_ref3 =
            (_ref4 =
              ...
              ? _ref4
              : defaultOptions3.weekStartsOn) !== null && _ref3 !== void 0
            ? _ref3
            : (_defaultOptions$local = defaultOptions3.locale) === null ||
                _defaultOptions$local === void 0
              ? void 0
  ...
  'node_modules/date-fns/isMatch/index.js'(exports2, module) {
    ...
    function isMatch(dateString, formatString, options) {
      ...
      return (0, _index2.default)(
        (0, _index.default)(dateString, formatString, /* @__PURE__ */ new Date(), options),
      )
    }
    module.exports = exports2.default
  },
...
var require_parseISO = __commonJS({
  'node_modules/date-fns/parseISO/index.js'(exports2, module) {
    ...
    function parseTime(timeString) {
      ...
      return (
        hours * _index.millisecondsInHour + minutes * _index.millisecondsInMinute + seconds * 1e3
      )
    }
  ...
  'node_modules/date-fns/roundToNearestMinutes/index.js'(exports2, module) {
    ...
    function roundToNearestMinutes(dirtyDate, options) {
      ...
      var nearestTo = (0, _index3.default)(
        (_options$nearestTo =
          options === null || options === void 0 ? void 0 : options.nearestTo) !== null &&
...
var CalDAV = {
  ...
  async getCalendar(calendarName, componentType = null) {
    ...
    if (!targetCal) {
      ...
      throw new Error(
        calendarName
          ? `${typeDesc}Calendar '${calendarName}' not found.`
          : `No ${typeDesc}calendars found.`,
      )
    }
    return targetCal
  },
...
var Contacts = {
  ...
  async getAddressBook(addressBookName) {
    ...
    if (!target) {
      throw new Error(
        addressBookName
          ? `Address book '${addressBookName}' not found.`
    ...
    if (command === 'notes') {
      ...
      if (subCommand === 'list') {
        ...
        const start =
          fromIndex !== -1
            ? args[fromIndex + 1]
            : (0, import_date_fns.formatISO)(/* @__PURE__ */ new Date())
        const end =
          toIndex !== -1
            ? args[toIndex + 1]
            : (0, import_date_fns.formatISO)(
      ...
      console.log(
        'Usage: node index.js <notes|files|calendar|calendars|tasks|contacts|addressbooks> <list|get|create|search|edit|delete> [options]',
      )
    }
  } catch (err) {
    errorOutput(err)
