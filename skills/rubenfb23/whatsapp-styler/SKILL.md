...
1. _Bold_: Use single asterisks around text: `*texto*`. NEVER use double asterisks `**`.
...
5. _Bullet Lists_: Use a single asterisk followed by a space: `* Item`.
6. _Numbered Lists_: Use standard numbers: `1. Item`.
7. _Quotes_: Use the angle bracket: `> texto`.

## Prohibited Patterns (Do NOT use)

- No headers (`#`, `##`, `###`). Use _BOLD CAPS_ instead.
