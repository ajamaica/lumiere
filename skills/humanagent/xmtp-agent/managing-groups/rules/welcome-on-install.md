...
async function sendWelcomeMessage(ctx: ConversationContext<unknown, Conversation>) {
  await ctx.conversation.sendText("👋 Welcome! I'm your XMTP agent. How can I help you today?")
}
