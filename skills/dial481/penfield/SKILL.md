          ...
          [
            {
              'id': 'npm',
              'kind': 'node',
              'package': 'openclaw-penfield',
              'global': true,
              'label': 'Install Penfield plugin',
            },
          ],
        'requires': { 'config': ['plugins.entries.openclaw-penfield.enabled'] },
      },
  }
---
...
```json
{
  "mcpServers": {
    "penfield": {
      "command": "npx",
      "args": ["mcp-remote@latest", "https://mcp.penfield.app/"]
    }
  }
}
```
