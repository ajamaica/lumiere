...
```json
{
  "include_domains": ["docs.python.org", "developer.mozilla.org", "reactjs.org"]
}
```
...
```json
{
  "include_domains": ["github.com", "gitlab.com", "bitbucket.org"]
}
```
...
```json
{
  "include_domains": ["scholar.google.com", "arxiv.org", "pubmed.ncbi.nlm.nih.gov"]
}
```
...
```json
{
  "exclude_domains": ["medium.com", "nytimes.com"]
}
```
...
```json
{
  ...
  "focus": "coding",
  "include_domains": ["swagger.io", "martinfowler.com", "developers.google.com", "aws.amazon.com"],
  "max_results": 10
}
```
