import { api, type CreateTaskInput, PRIORITY_MAP, type UpdateTaskInput } from '../api'
...
function parseDueDate(dueStr: string): string {
  ...
  throw new Error(
    `Invalid date format: ${dueStr}. Try 'today', 'tomorrow', 'in 3 days', or ISO date.`,
  )
}
