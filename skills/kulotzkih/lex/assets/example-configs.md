...
```json
{
  ...
  "capabilities": ["Current weather lookup", "Temperature conversion", "Weather forecasts"],
  "required_apis": {
...
```json
{
  ...
  "supported_chains": ["ethereum", "polygon", "solana", "arbitrum"],
  "deployment": {
    "type": "langgraph-cloud",
    "runtime": "typescript",
    "node_version": "18"
...
```json
{
  "agent": {
    ...
    "categories": ["defi", "analytics", "trading"],
