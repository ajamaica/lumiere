...
:root {
  ...
  --divider: oklch(0.9 0 0); /* Subtle divider */

  /* Interactive */
  --primary: oklch(0.65 0.24 267); /* Brand blue */
  --primary-hover: oklch(0.7 0.24 267);
  --primary-active: oklch(0.6 0.24 267);

  /* Semantic */
  --success: oklch(0.7 0.15 160); /* Green */
  --warning: oklch(0.75 0.15 85); /* Yellow */
  --error: oklch(0.65 0.2 25); /* Red */
  --info: oklch(0.7 0.15 250); /* Blue */
}
```
...
--primary-100: oklch(0.9 0.1 267);
--primary-200: oklch(0.85 0.15 267);
--primary-300: oklch(0.75 0.18 267);
--primary-400: oklch(0.7 0.21 267);
--primary-500: oklch(0.65 0.24 267); /* Base */
--primary-600: oklch(0.6 0.24 267);
--primary-700: oklch(0.5 0.22 267);
--primary-800: oklch(0.4 0.2 267);
--primary-900: oklch(0.3 0.18 267);
```
...
```css
/* Simple two-color */
background: linear-gradient(135deg, oklch(0.65 0.24 267), oklch(0.6 0.22 290));

/* Multi-stop */
background: linear-gradient(
  to bottom,
  oklch(0.7 0.24 267) 0%,
...
```css
background: radial-gradient(circle at center, oklch(0.7 0.24 267), oklch(0.5 0.22 280));
```
...
background:
  ...
  radial-gradient(at 80% 70%, oklch(0.7 0.2 290) 0px, transparent 50%), oklch(0.145 0 0);
```
...
_For dark mode implementation, see dark-mode.md. For complete design systems, see SKILL.md._
