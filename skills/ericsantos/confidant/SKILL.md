...
>
> _(AI executes: `npx @aiconnect/confidant serve-request --label "API Key"`)_
>
> **AI:** Open this link in your browser and enter your API key:
> `http://localhost:3000/requests/abc123`
>
> _(User opens URL in browser, submits the secret)_
>
...
>
> _(AI executes: `npx @aiconnect/confidant fill "http://..." --secret "...")_
>
