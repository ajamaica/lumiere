...
delegate_task(
  (category = 'deep'),
  (load_skills = []),
  (prompt = 'Investigate and fix the memory leak in the worker pool'),
)
```
...
delegate_task(
  (subagent_type = 'explore'),
  (run_in_background = true),
  (prompt = 'Find how auth middleware is implemented'),
)
delegate_task(
  (subagent_type = 'explore'),
  (run_in_background = true),
...
delegate_task(
  (subagent_type = 'librarian'),
  (run_in_background = true),
  (prompt = 'Find official JWT documentation and security recommendations'),
)
...
delegate_task(
  (category = 'quick'),
  (load_skills = ['git-master']),
  (prompt = 'Create atomic commit for auth changes'),
)
...
delegate_task(
  (category = 'ultrabrain'),
  (load_skills = []),
  (prompt = 'Design the caching invalidation strategy'),
)
```
