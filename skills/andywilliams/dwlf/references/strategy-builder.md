  ...
  "visual": {
    "nodes": [
      ...
      },
      {
        "id": "node-3",
        "type": "conditionNode",
        "nodeType": "dss.cross.bullish",
        "label": "DSS Crossed Above Signal",
      ...
      {
        "id": "node-11",
        "type": "cancellationStartNode",
        "nodeType": "cancellation_start",
        "label": "Cancellation",
        "position": { "x": 870, "y": 50 },
        "data": {
          "nodeType": "cancellation_start",
      ...
      },
      {
        "id": "node-12",
        "type": "conditionNode",
        "nodeType": "dss.overbought",
        "label": "DSS Entered Overbought Zone",
