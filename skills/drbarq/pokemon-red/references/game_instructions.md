...
```json
{
  "action": "buttons",
  "buttons": ["up", "up", "a"],
  "reasoning": "Walking north to town exit",
  "notepad": "Heading to Route 1"
}
```
...
```json
{
  "action": "fight",
  "move_index": 0,
  "reasoning": "Tackle is my only damaging move",
  "notepad": "Fighting wild Rattata"
}
```
...
{
  "action": "run",
  "reasoning": "HP too low to risk another hit",
  "notepad": "Need to heal after this"
}
```
...
{
  "action": "navigate",
  "destination": "Viridian Pokecenter",
  "reasoning": "Need to heal before Route 2",
  "notepad": "Will heal then head north"
}
```
...
{
  "action": "heal",
  "reasoning": "Party HP critical after grinding",
  "notepad": "Heal up then continue quest"
}
```
...
```json
{
  ...
  "lesson": "Viridian Mart triggers Oak's Parcel cutscene automatically on entry",
  "reasoning": "Just picked up the parcel, step is done",
  "notepad": "Parcel obtained, need to go back to Oak"
}
```
...
{
  "action": "save",
  "reasoning": "Good checkpoint before entering Viridian Forest",
  "notepad": "Saved before forest"
}
```
