...
module.exports = {
  ...
  metadata: {
    filesModified: ['dist/auto-reply/reply/dispatch-from-config.js', 'dist/tts/tts.js'],
    keyChange:
      'Added disableBlockStreaming: ttsWillFire to ensure final payload reaches TTS pipeline',
