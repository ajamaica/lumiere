...
metadata:
  {
    'clawdbot':
      {
        'requires': { 'bins': ['uv'], 'env': ['SOLANA_PRIVATE_KEY'] },
        'emoji': '🎯',
          ...
          [
            {
              ...
              'from': 'git+https://github.com/maddefientist/SlopeSniper.git#subdirectory=mcp-extension',
              'bins': ['slopesniper-mcp', 'slopesniper-api'],
