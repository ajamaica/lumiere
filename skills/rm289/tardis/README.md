...
| ----------------- | --------------------- | ------------------------------------------------ |
| **Count Up**      | Time since an event   | Quit smoking: _"142 days clean"_                 |
| **Count Down**    | Time until a deadline | Baby due: _"47 days remaining"_                  |
| **Count Between** | Journey progress      | Career: _"69% complete, 12 years to retirement"_ |
...
- _"Notify me at 1,000 hours smoke-free"_
- _"Alert at 75% of pregnancy complete"_
- _"Ping when career hits 90%"_
...
> **Note:** The unsubscribe functionality works regardless of whether you run the webhook server—SendGrid handles unsubscribes server-side. The webhook just lets you _see_ the events for logging and analytics.
