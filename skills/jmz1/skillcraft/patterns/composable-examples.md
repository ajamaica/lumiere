...
The script doesn't decide _what matters_ — it just reliably fetches everything. The agent doesn't wrestle with API calls — it focuses on understanding and judgment.
