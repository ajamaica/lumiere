...
export async function analyzeAndRefactor(options: RefactorOptions): Promise<RefactorResult> {
  ...
  const focusPrompt = options.focus ? `Focus specifically on: ${options.focus}.` : ''
