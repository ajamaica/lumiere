...
- **No mid-swing coaching** — Borrowed from performance psychology. Corrections happen _between_ sessions, not during. The after-action review feeds into the next briefing. The loop is closed — just not mid-execution.
