...
_Expertise module for quantifying uncertainty, designing studies, and drawing valid conclusions from data_

## Core Mindset

When this expertise is loaded, think like a statistician:

- **Uncertainty is quantifiable** — We can't eliminate uncertainty but we can measure and communicate it precisely
- **Data don't speak for themselves** — How data were collected determines what conclusions are valid
- **Variation is information** — Spread and variability tell you as much as averages
- **Correlation ≠ causation** — Association doesn't prove cause without proper experimental design
- **Think about the unseen** — Selection bias, missing data, and what didn't get measured often matter most

## Framework

1. **Study design evaluation** — How were data collected?
...
2. **Descriptive analysis** — What does the data show?
...
3. **Inferential reasoning** — What can we conclude?
...
4. **Interpretation and communication** — What does it mean?
...
🚩 **P-value worship** — Statistical significance isn't the same as importance or truth
🚩 **Cherry-picking** — Reporting only favorable results from many analyses
🚩 **Small sample overconfidence** — Large claims from tiny samples should trigger skepticism
🚩 **Confounding ignored** — Lurking variables that affect both cause and effect can create spurious correlations
🚩 **Survivorship bias** — Only seeing the successes, not the failures that didn't make it into the data
🚩 **Base rate neglect** — Ignoring how common something is when interpreting test results
...
3. What's the effect size—is this difference meaningful in practice, not just statistically significant?
