...
metadata:
  {
    'moltbot': { 'category': 'finance', 'api_base': 'https://agentwallet.mcpay.tech/api' },
    'x402':
      {
        'supported': true,
        'chains': ['solana', 'evm'],
    ...
    'referrals': { 'enabled': true, 'endpoint': '/api/wallets/{username}/referrals' },
  }
---
...
```json
{
  ...
  "trending": {
    "apis": [{ "url": "https://enrichx402.com/api/exa/search", "callCount": 234 }]
  },
