...
import { DatabaseError, DatabaseManager } from '../database-manager'
...
describe('DatabaseManager', () => {
  ...
  describe('Error Handling', () => {
    ...
    test('throws DatabaseError on invalid trust_score', () => {
      ...
      expect(() => db.upsertUserReputation(reputation)).toThrow(
        /trust_score must be a non-negative number/,
      )
    })
    ...
    test('validates attack pattern fields', () => {
      ...
      expect(() => db.upsertAttackPattern(pattern)).toThrow(
        /times_matched must be a positive integer/,
      )
    })
    ...
    test('validates rate limit fields', () => {
      ...
      expect(() => db.upsertRateLimit(rateLimit)).toThrow(
