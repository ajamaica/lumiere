...
import { authenticate, authenticateManual, checkAuth, logout, setupCredentials } from './auth'
...
// Auth command
const authCmd = program.command('auth').description('Authenticate with TickTick')
