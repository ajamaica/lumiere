...
export function createCardsCommands(): Command {
  const cards = new Command('cards').description('Manage Fizzy cards')
  ...
  cards
    ...
    .action(async (number: string, options) => {
      ...
      try {
        ...
        console.error(
          chalk.red('Failed to close card:'),
          error instanceof Error ? error.message : error,
        )
        process.exit(1)
      }
  ...
  cards
    ...
    .action(async (number: string, options) => {
      ...
      try {
        ...
        console.error(
          chalk.red('Failed to reopen card:'),
          error instanceof Error ? error.message : error,
        )
        process.exit(1)
      }
  ...
  cards
    ...
    .action(async (number: string, options) => {
      ...
      try {
        ...
        console.error(
          chalk.red('Failed to assign card:'),
          error instanceof Error ? error.message : error,
        )
        process.exit(1)
      }
  ...
  cards
    ...
    .action(async (number: string, options) => {
      ...
      try {
        ...
        console.error(
          chalk.red('Failed to unassign card:'),
          error instanceof Error ? error.message : error,
        )
        process.exit(1)
      }
  ...
  cards
    ...
    .action(async (number: string, options) => {
      ...
      try {
        ...
        console.log(
          chalk.green(
            `✓ Card #${cardNumber} ${options.unset ? 'removed from' : 'marked as'} "not now"`,
          ),
        )
      } catch (error) {
        console.error(
