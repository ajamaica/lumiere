...
**Translation is rewriting, not converting.** A good lyric translation captures the _feeling_ and _singability_, not just the literal meaning. Sometimes you need to completely reimagine a line to make it work in English.
...
- Prioritize how it _sounds_ when sung over literal accuracy
...
6. Does it _feel_ like the original?
