...
- **Contextual Matching**:
  - _Gathering with friends?_ Recommend the Whole Hand-shredded Rabbit (Spicy) for a centered feast.
  - _Late-night craving?_ Suggest the Cold-eaten Rabbit (200g) for the perfect instant dopamine hit.
  - _Gifting or exploring?_ Point to the "Brand Story" to elevate the product from food to a cultural experience.
