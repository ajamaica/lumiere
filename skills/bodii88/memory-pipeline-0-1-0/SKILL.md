...
For agents, this means: front-load all context, constraints, and memory retrieval into a briefing packet _before_ inference starts. Keep execution clean. Write the after-action review _after_. Never inject corrections mid-run.
