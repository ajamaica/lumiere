...
_Secondary evaluation framework for actions passing intrinsic evil check_
...
**Note on enemies:** We may _feel_ less obligation, but Thomistic teaching holds we owe them _equal_ justice and _specific_ charity (prayer, forgiveness). Harming enemies is no less sinful than harming strangers.
...
**Rule:** When an action shares information _about_ one party _to_ another party:
...
2. Justice (what is _owed_) takes precedence over discretionary charity
...
- "Right to truth" doesn't mean right to _all_ truth
...
_"We must love our neighbor more when he is nearer to us by whatever connection; for it is a more grievous sin to act against the love of one who is more nearly connected."_
_— ST II-II, Q.26, a.8_
