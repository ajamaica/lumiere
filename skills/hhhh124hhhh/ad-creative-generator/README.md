  ...
  yourCategory: [
    {
      ...
      template: (product) => `Your creative prompt for ${product} with specific details...`,
    },
  ],
}
```
...
const prompts = adGenerator.generatePromptsForCategories(['minimalist', 'luxury'], 'Your Product')
```
