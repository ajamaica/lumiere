    ...
    'clawdbot':
      {
        ...
        'defaultEnv': { 'BEEPER_API_URL': 'http://localhost:23373' },
      },
  }
user-invocable: true
---
...
Finally, your Clawdbot can reach you (and everyone else) across _every_ chat platform. WhatsApp? Telegram? Signal? Discord? Slack? Instagram DMs? LinkedIn? iMessage? **All of them. One skill. One claw.**
...
_(For those who like to peek under the shell)_
...
[
  {
    ...
    "timestamp": "2026-01-23T15:30:00Z",
    "reactions": [{ "emoji": "👍", "user": { "id": "user-2", "name": "Dad" } }]
  },
  {
    "id": "msg-002",
    "chatID": "chat-abc123",
...
_Claw Me Maybe - because your lobster should be able to reach you anywhere._
