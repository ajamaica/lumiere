...
metadata:
  {
    'moltbot':
      {
        'emoji': '☁️',
        'requires': { 'bins': ['sf'], 'env': ['SALESFORCE_ACCESS_TOKEN'] },
        'primaryEnv': 'SALESFORCE_ACCESS_TOKEN',
        'install':
          [
            {
              'id': 'npm',
              ...
              'bins': ['sf'],
              'label': 'Install Salesforce CLI (npm)',
            },
            {
              'id': 'brew',
              'kind': 'brew',
              'formula': 'salesforce-cli',
              'bins': ['sf'],
              'label': 'Install Salesforce CLI (brew)',
            },
          ],
      },
  }
