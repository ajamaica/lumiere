...
metadata:
  {
    'openclaw':
      {
        'requires': { 'bins': ['pdftotext', 'pdfinfo'] },
        'install':
          [
            {
              'id': 'poppler',
              'kind': 'shell',
              'command': 'apt-get install -y poppler-utils || brew install poppler || choco install poppler',
              'bins': ['pdftotext', 'pdfinfo', 'pdftoppm', 'pdfunite', 'pdfseparate'],
              'label': 'Install poppler-utils',
            },
            {
              'id': 'qpdf',
              'kind': 'shell',
              'command': 'apt-get install -y qpdf || brew install qpdf || choco install qpdf',
              'bins': ['qpdf'],
              'label': 'Install qpdf (optional)',
            },
            {
              'id': 'ocrmypdf',
              'kind': 'pip',
              'package': 'ocrmypdf',
              'bins': ['ocrmypdf'],
              'label': 'Install ocrmypdf for OCR (optional)',
            },
          ],
      },
  }
