...
export const pathTraversalPatterns: SecurityPattern[] = [
  ...
  },
  {
    ...
    examples: ['%2e%2e%2f', '%2e%2e/', '..%2f', '..%5c', '%2e%2e%5c'],
    falsePositiveRisk: 'low',
    enabled: true,
  ...
  },
  {
    ...
    examples: ['%252e%252e%252f', '%252e%252e/', '%252e%252e%255c'],
    falsePositiveRisk: 'low',
    enabled: true,
  ...
  },
  {
    ...
    examples: ['/etc/passwd', '/etc/shadow', '../../etc/passwd', 'files/../../../etc/shadow'],
    falsePositiveRisk: 'low',
    enabled: true,
  ...
  },
  {
    ...
    pattern:
      /(?:\\windows\\system32\\config\\(?:sam|system|security)|\/windows\/system32\/config\/(?:sam|system|security))/i,
    severity: Severity.CRITICAL,
    language: 'all',
  ...
  },
  {
    ...
    examples: ['config.php.bak', 'database.sql.backup', 'secret.txt.old', 'data.json.tmp', 'file~'],
    falsePositiveRisk: 'medium',
    enabled: true,
  ...
  },
  {
    ...
    examples: ['/proc/self/environ', '/proc/self/cmdline', '/proc/1/environ', '/proc/self/maps'],
    falsePositiveRisk: 'low',
    enabled: true,
  ...
  },
  {
    ...
    examples: ['file.txt%00.jpg', '../../../etc/passwd%00', 'config%00.php'],
    falsePositiveRisk: 'low',
    enabled: true,
