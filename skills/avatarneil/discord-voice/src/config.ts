...
export function parseConfig(raw: unknown): DiscordVoiceConfig {
  ...
  return {
    ...
    streamingSTT:
      typeof obj.streamingSTT === 'boolean' ? obj.streamingSTT : DEFAULT_CONFIG.streamingSTT,
    ...
    maxRecordingMs:
      typeof obj.maxRecordingMs === 'number' ? obj.maxRecordingMs : DEFAULT_CONFIG.maxRecordingMs,
    autoJoinChannel:
    ...
    openai:
      obj.openai && typeof obj.openai === 'object'
        ? {
            ...
            whisperModel:
              ((obj.openai as Record<string, unknown>).whisperModel as string) || 'whisper-1',
    ...
    elevenlabs:
      obj.elevenlabs && typeof obj.elevenlabs === 'object'
        ? {
            ...
            modelId:
              ((obj.elevenlabs as Record<string, unknown>).modelId as string) ||
