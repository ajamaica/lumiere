...
🟡 **DAMAGING:** 4. **Copy-paste Leiden without local adaptation** → Doesn't resonate
...
🟢 **ANNOYING:** 7. **Facility not ready in time** → Delayed opening
...
🟡 **DAMAGING:** 3. **Photos are bad quality** → Parents unimpressed
...
🟢 **ANNOYING:** 6. **App crashes occasionally** → Frustration
...
🟡 **DAMAGING:** 4. **Price too high** → Immediate rejection
