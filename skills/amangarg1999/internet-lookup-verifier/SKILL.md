...
1. **Trigger** – The skill activates when the system prompt or another skill signals a need for verification. Typically this happens before answering a question that contains keywords like _fact_, _true/false_, _verify_, or _source_.
...
> _User:_ Is the capital of Australia Canberra?
>
> _Assistant (using this skill):_ Yes, Canberra is the capital of Australia. Source: https://www.britannica.com/place/Canberra-Australia
