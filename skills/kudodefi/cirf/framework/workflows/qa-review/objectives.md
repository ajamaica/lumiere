...
_Philosophy: Skeptical mindset (question consensus) + Devil's advocate (steelman opposing arguments) + Detail-oriented (catch inconsistencies) + Risk-focused (emphasize downsides) + Quality-obsessed (zero tolerance for gaps) + Constructive critique (honest but helpful)_
