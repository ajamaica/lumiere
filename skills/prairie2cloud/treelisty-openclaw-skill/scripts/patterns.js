  ...
  generic: {
    ...
    fields: {
      ...
      alternateSource: {
        ...
        description: 'Backup vendor or alternative solution',
      },
  ...
  thesis: {
    ...
    fields: {
      ...
      evidenceType: {
        type: 'select',
        label: 'Evidence Type',
        options: ['Empirical', 'Theoretical', 'Mixed', 'N/A'],
      },
    },
  ...
  roadmap: {
    ...
    fields: {
      storyPoints: {
        type: 'number',
        label: 'Story Points',
        description: 'Effort estimate (Fibonacci)',
      },
  ...
  book: {
    ...
    fields: {
      ...
      plotFunction: {
        type: 'select',
        label: 'Plot Function',
        options: ['Setup', 'Conflict', 'Resolution', 'Transition'],
      },
    },
    includeTracking: false,
    includeDependencies: true,
  ...
  fitness: {
    ...
    fields: {
      ...
      intensity: {
        type: 'select',
        label: 'Intensity',
        options: ['Light', 'Moderate', 'High', 'Max'],
      },
  ...
  strategy: {
    ...
    fields: {
      ...
      strategicTheme: {
        type: 'select',
        label: 'Theme',
        options: ['Growth', 'Efficiency', 'Innovation', 'Transformation', 'Risk Mitigation'],
      },
  ...
  course: {
    ...
    fields: {
      ...
      assessmentType: {
        type: 'select',
        label: 'Assessment',
        options: ['Quiz', 'Assignment', 'Project', 'Discussion', 'Exam', 'None'],
      },
  ...
  film: {
    ...
    fields: {
      ...
      duration: {
        type: 'select',
        label: 'Duration',
        options: ['2s', '4s', '6s', '10s', '20s', 'Extended'],
      },
      aspectRatio: {
        type: 'select',
        label: 'Aspect Ratio',
        options: ['16:9', '9:16', '1:1', '2.39:1', '4:3'],
      },
      cameraMovement: {
        type: 'select',
        label: 'Camera Movement',
        options: ['Static', 'Pan', 'Dolly', 'Tracking', 'Crane', 'Handheld', 'Orbiting'],
      },
      motionIntensity: {
        type: 'select',
        label: 'Motion',
        options: ['Minimal', 'Subtle', 'Moderate', 'Dynamic', 'Intense'],
      },
      lightingMood: {
        type: 'select',
        label: 'Lighting',
        options: ['Golden Hour', 'Overcast', 'Night', 'Neon', 'Dramatic', 'Studio', 'Natural'],
      },
  ...
  veo3: {
    ...
    fields: {
      flowMode: {
        type: 'select',
        label: 'Flow Mode',
        options: ['Ingredients', 'Frames', 'Extend', 'Standard'],
      },
      ...
      extendDuration: {
        ...
        options: ['10s', '20s', '30s', '60+ seconds'],
      },
      ...
      audioType: {
        type: 'select',
        label: 'Audio',
        options: ['Dialogue', 'Sound Effects', 'Ambience', 'Mixed', 'Silent'],
      },
      cinematicStyle: {
        type: 'select',
        label: 'Style',
        options: ['Realistic', 'Dramatic', 'Documentary', 'Commercial', 'Artistic', 'Music Video'],
      },
    },
    includeTracking: true,
    includeDependencies: true,
  ...
  sora2: {
    ...
    fields: {
      ...
      beatType: {
        type: 'select',
        label: 'Beat Type',
        options: ['Setup', 'Conflict', 'Transition', 'Resolution', 'Character Moment'],
      },
      cameoUsed: {
        type: 'select',
        label: 'Cameo',
        options: ['None', 'Cameo ID 1', 'Cameo ID 2', 'Cameo ID 3'],
      },
      ...
      nleExportFormat: {
        type: 'select',
        label: 'NLE Export',
        options: ['Premiere', 'Final Cut', 'DaVinci', 'After Effects', 'Raw'],
      },
      audioSync: {
        type: 'select',
        label: 'Audio Sync',
        options: ['Synchronized Dialogue', 'Sound Effects', 'Background Score', 'Silent'],
      },
    },
    includeTracking: true,
    includeDependencies: true,
  ...
  philosophy: {
    ...
    fields: {
      ...
      validity: {
        type: 'select',
        label: 'Validity',
        options: ['Valid', 'Invalid', 'Sound', 'Unsound', 'Uncertain'],
      },
      ...
      textualReference: {
        type: 'text',
        label: 'Reference',
        description: 'Stephanus number or citation',
      },
      philosophicalSchool: {
        type: 'select',
        label: 'School',
  ...
  prompting: {
    ...
    fields: {
      systemPrompt: {
        type: 'textarea',
        label: 'System Prompt',
        description: 'AI role and behavior',
        required: true,
      },
      userPromptTemplate: {
        type: 'textarea',
  ...
  familytree: {
    ...
    fields: {
      ...
      relationshipType: {
        type: 'select',
        label: 'Relationship',
        options: ['Biological', 'Adopted', 'Step', 'Foster', 'In-Law', 'Unknown'],
      },
    },
    includeTracking: false,
    includeDependencies: true,
  ...
  dialogue: {
    ...
    fields: {
      ...
      evidenceQuality: {
        ...
        options: ['Strong', 'Moderate', 'Weak', 'None', 'Misleading'],
      },
      effectivenessRating: {
        type: 'number',
        label: 'Effectiveness',
        description: 'Persuasiveness (1-10)',
        min: 1,
        max: 10,
      },
    },
  ...
  filesystem: {
    ...
    fields: {
      ...
      permissions: {
        type: 'select',
        label: 'Permissions',
        options: ['Read Only', 'Read/Write', 'Owner', 'Admin', 'None'],
      },
      driveType: {
        type: 'select',
        label: 'Drive',
        options: ['Local', 'Google Drive', 'OneDrive', 'Dropbox', 'iCloud', 'S3', 'Other'],
      },
  ...
  'knowledge-base': {
    ...
    fields: {
      ...
      relevanceScore: {
        type: 'number',
        label: 'Relevance',
        description: 'How relevant (0-100)',
        min: 0,
        max: 100,
      },
  ...
  capex: {
    ...
    fields: {
      ...
      valuationImpact: {
        ...
        description: 'How this affects valuation',
      },
