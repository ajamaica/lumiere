...
export function createBoardsCommands(): Command {
  const boards = new Command('boards').description('Manage Fizzy boards')
  ...
  boards
    ...
    .action(async (options) => {
      ...
      try {
        ...
        console.error(
          chalk.red('Failed to list boards:'),
  ...
  boards
    ...
    .action(async (options) => {
      ...
      try {
        ...
        console.error(
          chalk.red('Failed to create board:'),
          error instanceof Error ? error.message : error,
        )
        process.exit(1)
      }
  ...
  boards
    ...
    .action(async (slug: string, options) => {
      ...
      try {
        ...
        console.error(
          chalk.red('Failed to update board:'),
          error instanceof Error ? error.message : error,
        )
        process.exit(1)
      }
  ...
  boards
    ...
    .action(async (slug: string) => {
      ...
      try {
        ...
        console.error(
          chalk.red('Failed to delete board:'),
          error instanceof Error ? error.message : error,
        )
        process.exit(1)
      }
  ...
  boards
    ...
    .action(async (slug: string) => {
      ...
      try {
        ...
        console.error(
          chalk.red('Failed to archive board:'),
          error instanceof Error ? error.message : error,
        )
        process.exit(1)
      }
