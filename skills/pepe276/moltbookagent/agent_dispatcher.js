...
class AgentDispatcher {
  ...
  loadAgentConfigurations() {
    ...
    const soulFiles = fs.readdirSync(SOULS_DIR).filter((file) => file.endsWith('_soul.json'))
...
НЕ БУДЬ НУДНИМ.
    ...
    const modelId = agent.role === 'conscious' ? 'llama-3.3-70b-versatile' : 'llama-3.1-8b-instant'
