...
```json
{
  ...
  "block_critical": true,
  "trusted_authors": ["official", "PaxSwarm", "verified-publisher"],
  "allowed_domains": ["api.openai.com", "api.anthropic.com", "api.github.com", "clawhub.ai"],
...
_Built by [PaxSwarm](https://github.com/G0HEAD) — protecting the swarm, one skill at a time_ 🐦‍⬛
