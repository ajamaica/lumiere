...
export function ComponentName({ required, optional = false, children }: ComponentNameProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      ...
      <section className="mb-12">
        ...
        <Card title="Example Card">Card content here</Card>
      </section>
    </div>
  )
}
...
<button type="{{ type }}" class="btn btn-{{ variant }} btn-{{ size }}">{{ text }}</button>
{% endmacro %}
```
