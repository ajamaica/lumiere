...
- [ ] **@Sarah**: Share website mockups — _Friday_
- [ ] **@Team**: Provide feedback on mockups — _Monday_
- [ ] **@Sarah**: Update project timeline with new launch date
- [ ] **@John**: Handle social media campaigns (needs design assets)
- [ ] **@Lisa**: Coordinate with agency on paid campaigns — _Today_
- [ ] **@Mike**: Call Acme Corp about performance issues — _Tomorrow_
- [ ] **@Mike**: Check with leadership about potential discount for Acme
- [ ] **@Sarah**: Post senior dev job listing — _End of week_
...
```json
{
  ...
  "decisions": ["Website launch pushed back 2 weeks", "Q1 marketing budget approved at $50k"],
  "open_questions": ["How to resolve Acme Corp issue"],
...
_Same messy input. Clean, saved, tracked output. Every time._
