          ...
          [
            {
              'id': 'curl-install',
              'kind': 'script',
              'url': 'https://raw.githubusercontent.com/BAGWATCHER/SlopeSniper/main/skills/install.sh',
              'bins': ['slopesniper'],
              'label': 'Install SlopeSniper (recommended)',
            },
            {
              'id': 'uv-install',
              'kind': 'uv',
              'package': 'slopesniper-mcp',
              'from': 'git+https://github.com/BAGWATCHER/SlopeSniper.git#subdirectory=mcp-extension',
              'bins': ['slopesniper'],
              'label': 'Install via uv (advanced)',
            },
          ],
      },
    'clawdbot':
