  ...
  "patterns": [
    {
      ...
      "evidence_checklist": ["Document technical specifications", "Note development timeline"]
    }
  ],
  "next_steps": [
...
_Research strategy by [patent-validator](https://obviouslynot.ai) from obviouslynot.ai_
```
