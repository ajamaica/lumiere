...
It's chaos. Real, actual chaos. The point of the current implementation is to show the _intent_ - what agents want to do based on their values. Execution just proves they'll follow through.
