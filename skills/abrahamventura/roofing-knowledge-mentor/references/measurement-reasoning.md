...
This guide focuses on _judgment, sanity checks, and risk awareness_ — not formulas or automation.
...
- When pitch varies across planes, treat the roof as _multiple roofs_, not one
...
Most costly errors come from _assumptions_, not math.
