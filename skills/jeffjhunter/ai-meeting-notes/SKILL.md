...
- [ ] **@Owner**: Task description — _Deadline_
- [ ] **@Owner**: Task description — _Deadline_
...
- [ ] **@Sarah**: Finalize Q1 campaign — _Friday_
- [ ] **@John**: Send assets — _Wednesday_
- [ ] **@Mike**: Confirm budget allocation ($50k approved)
- [ ] **@Team**: Resolve vendor situation — _TBD_
...
_Built by Jeff J Hunter — https://jeffjhunter.com_

_Part of the OpenClaw skills ecosystem. More at https://clawhub.org_
