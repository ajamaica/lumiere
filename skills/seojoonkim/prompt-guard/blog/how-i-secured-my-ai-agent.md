...
_A practical guide to defending your Moltbot/Clawdbot assistant in group chats_
...
_Built for the [Moltbot](https://github.com/moltbot/moltbot) and [Clawdbot](https://github.com/clawdbot/clawdbot) community._

_Questions? Open an issue or join the [Discord](https://discord.gg/clawd)._
