    ...
    messages: [
      {
        role: 'system',
        content:
          'You are a database performance expert. Analyze SQL queries and Prisma/ORM code for performance issues: N+1 queries, missing indexes, unnecessary joins, unoptimized WHERE clauses, missing pagination. Provide optimized versions with explanations. Be concise.',
      },
