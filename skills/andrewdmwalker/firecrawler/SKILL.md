...
- _"Scrape https://blog.example.com/post and summarize it"_
- _"Take a screenshot of stripe.com"_
- _"Extract the name, price, and features from this product page"_
- _"Crawl the Astro docs so you can help me build a site"_
- _"Map all the URLs on docs.stripe.com"_
