...
SKILL.md sagt explizit: _"use the **numeric `id`** field from the findings response (not the `ecap_id` string like `ECAP-2026-0777`)"_ — das ist **falsch**. Die API akzeptiert NUR `ecap_id` Strings. Numerische IDs geben immer `"Finding not found"`.
