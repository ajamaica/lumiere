...
_A clear view of what’s happening, without telling you what to do._
...
**Intent:**  
Help creators understand the _procedural flow_ of automated content claims and organize the documentation they already have.
...
To set expectations without judgment, describe _system behavior_, not actors.
...
2. **Usage description:** How would you describe the use (e.g., review, parody, educational)?  
   _Note: Platform criteria for these categories vary._
...
```json
{
  "platform": "string",
  "claim_type": "string",
  "match_segments": [{ "start": "string", "end": "string" }],
