...
_[Theme/tagline for the week]_
...
- [ ] Item — quantity — **~£X.XX** _(used in: Day 1, Day 3)_  
      💰 _[Price note]_
...
- **[Artist]** — "[Track]" ([Year]) — _[brief note]_
- **[Artist]** — "[Track]"

**Classic/Traditional:**

- **[Artist]** — "[Track]" ([Era]) — _[brief note]_
- **[Artist]** — "[Track]"
...
_[Repeat full structure for each cooking day...]_
