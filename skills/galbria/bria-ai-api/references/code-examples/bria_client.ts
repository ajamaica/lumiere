...
export class BriaClient {
   ...
   */
  async generate(prompt: string, options: GenerateOptions = {}): Promise<BriaResponse> {
    const { aspectRatio = '1:1', negativePrompt, numResults = 1, seed, wait = true } = options
   ...
   * @returns Response with edited image_url
   */
  async erase(imageUrl: string, maskUrl: string, wait = true): Promise<BriaResponse> {
    return this.request('/v2/image/edit/erase', { image: imageUrl, mask: maskUrl }, wait)
  }
   ...
   * @returns Response with edited image_url
   */
  async replaceBackground(imageUrl: string, prompt: string, wait = true): Promise<BriaResponse> {
    return this.request('/v2/image/edit/replace_background', { image: imageUrl, prompt }, wait)
  }
   ...
   */
  async expandImage(imageUrl: string, options: ExpandOptions = {}): Promise<BriaResponse> {
   ...
   */
  async increaseResolution(imageUrl: string, scale: 2 | 4 = 2, wait = true): Promise<BriaResponse> {
    return this.request('/v2/image/edit/increase_resolution', { image: imageUrl, scale }, wait)
  }
   ...
   * @returns Response with edited image_url
   */
  async addObject(imageUrl: string, instruction: string, wait = true): Promise<BriaResponse> {
    return this.request('/v2/image/edit/add_object_by_text', { image: imageUrl, instruction }, wait)
  }
   ...
   * @returns Response with edited image_url
   */
  async replaceObject(imageUrl: string, instruction: string, wait = true): Promise<BriaResponse> {
    return this.request(
   ...
   * @returns Response with edited image_url
   */
  async eraseObject(imageUrl: string, objectName: string, wait = true): Promise<BriaResponse> {
    return this.request(
   ...
   */
  async restyle(imageUrl: string, options: RestyleOptions): Promise<BriaResponse> {
   ...
   */
  async relight(imageUrl: string, lightType: string, wait = true): Promise<BriaResponse> {
    return this.request('/v2/image/edit/relight', { image: imageUrl, light_type: lightType }, wait)
  }
   ...
   * @returns Response with edited image_url
   */
  async replaceText(imageUrl: string, newText: string, wait = true): Promise<BriaResponse> {
    return this.request('/v2/image/edit/replace_text', { image: imageUrl, new_text: newText }, wait)
  }
   ...
   */
  async sketchToImage(imageUrl: string, prompt?: string, wait = true): Promise<BriaResponse> {
   ...
   */
  async colorize(imageUrl: string, options: ColorizeOptions = {}): Promise<BriaResponse> {
