...
metadata:
  {
    'moltbot':
      {
        'emoji': '🐽',
        'requires': { 'bins': ['curl'], 'env': ['CREATORDB_API_KEY'] },
...
```json
{
  "data": {
    ...
    "topics": ["freegames_Gaming"],
    "niches": ["roblox_Gaming"],
    "otherLinks": [
      {
        "title": "Instagram",
    ...
    "relatedCreators": ["UCBR8-60-B28hp2BmDPdntcQ", "UC4PooiX37Pld1T8J5SYT-SQ"],
    "videoPrice": {
      "cpmLow": 5.5,
      "cpmRaw": 8.2,
      "cpmHigh": 12,
