...
1. **fetch\_{repo}\_documentation** - Fetch entire documentation. Call first for general questions.
2. **search\_{repo}\_documentation** - Semantic search within docs. Use for specific queries.
3. **search\_{repo}\_code** - Search code via GitHub API (exact match). Returns matching files.
