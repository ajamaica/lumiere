...
const CITY_PRESETS = {
  ...
  'los angeles': {
    ...
    feeds: ['https://www.latimes.com/local/rss2.0.xml', 'https://abc7.com/feed/'],
  },
  'new york': {
    lat: 40.7128,
    lon: -74.006,
    keywords: ['new york', 'nyc', 'manhattan', 'brooklyn', 'queens'],
    feeds: ['https://rss.nytimes.com/services/xml/rss/nyt/NYRegion.xml'],
  },
  chicago: {
    lat: 41.8781,
    lon: -87.6298,
    keywords: ['chicago', 'cook county', 'illinois', 'evanston'],
    feeds: ['https://www.chicagotribune.com/news/rss2.0.xml'],
  },
}
...
async function geocodeCity(city) {
  return new Promise((resolve, reject) => {
    ...
    https
      .get(url, { headers: { 'User-Agent': 'LocationSafetySetup/1.0' } }, (res) => {
        let data = ''
...
async function interactiveSetup() {
  ...
  console.log(
    ...
    `(${config.location.defaultLat.toFixed(4)}, ${config.location.defaultLon.toFixed(4)})`,
  )
