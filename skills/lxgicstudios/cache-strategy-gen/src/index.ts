    ...
    messages: [
      {
        role: 'system',
        content:
          'You are a backend performance expert. Analyze the API code and suggest caching strategies: HTTP cache headers, Redis caching, in-memory caching, CDN caching, stale-while-revalidate patterns. For each endpoint, recommend TTL, invalidation strategy, and implementation code. Be concise.',
      },
