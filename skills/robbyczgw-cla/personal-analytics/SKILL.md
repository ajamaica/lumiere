...
```json
{
  ...
  "insights": {
    "productivity_markers": ["completed", "shipped", "fixed", "merged", "deployed"],
    "stress_indicators": ["urgent", "asap", "critical", "broken", "emergency"]
  },
  "reports": {
    "weekly_day": "sunday",
    "weekly_time": "20:00",
...
{
  "privacy": {
    "exclude_patterns": ["password", "token", "key", "secret", "credit card", "ssn", "api key"]
  }
}
```
