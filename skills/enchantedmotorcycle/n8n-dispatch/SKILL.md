...
| ------------ | ------------------------------------------ | --------------------------------------------------------------------------- | ------------------------------- |
| `state`      | _“Is the garage door open?”_               | `n8n_dispatch dispatch state "Is the garage door open?"`                    | _“Garage door is closed”_       |
| `action`     | _“Turn on the hallway light.”_             | `n8n_dispatch dispatch action "Turn on the hallway light."`                 | _“Hallway light turned on”_     |
| `historical` | _“Show me the temperature for yesterday.”_ | `n8n_dispatch dispatch historical "Show me the temperature for yesterday."` | _Yesterday’s temperature: 72°F_ |
