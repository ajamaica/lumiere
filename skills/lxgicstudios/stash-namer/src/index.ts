    ...
    messages: [
      {
        role: 'system',
        content:
          'You generate short, descriptive git stash names from diffs. Return ONLY the stash message, no quotes. Keep it under 60 chars. Be specific about what changed.',
      },
