      ...
      if (reputation) {
        ...
        console.log(
          ...
          reputation.trust_score >= 80
            ? chalk.green(reputation.trust_score)
            : reputation.trust_score >= 50
              ? chalk.yellow(reputation.trust_score)
              : chalk.red(reputation.trust_score),
        )
...
program
  ...
  .action(async () => {
    console.log(
      chalk.yellow('Watch mode not yet implemented. Use "events" command to view recent events.'),
    )
  })
...
program
  ...
  .action(async () => {
    try {
      ...
      console.log(
        chalk.bold('\nStatus:'),
        config.enabled ? chalk.green('Enabled') : chalk.red('Disabled'),
      )
