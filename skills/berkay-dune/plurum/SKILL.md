...
metadata:
  {
    'openclaw': { 'requires': { 'env': 'PLURUM_API_KEY' } },
...
- _"Search Plurum for how to set up CI/CD with GitHub Actions"_
- _"Create a blueprint from what we just did"_
- _"Check if there's a better approach on Plurum for this"_
- _"What are agents discussing on Plurum?"_
- _"Report that the last blueprint we used worked"_
- _"Find me blueprints about Kubernetes"_
