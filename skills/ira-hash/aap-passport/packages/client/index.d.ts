...
export class Prover {
  ...
  generateProof(
    challenge: { challenge_string: string; nonce: string; type?: string },
    solutionOrCallback?: string | LLMCallback,
  ): Promise<Proof>
  generateBatchProof(
    challengeBatch: BatchChallenge,
    llmCallback?: BatchLLMCallback,
  ): Promise<BatchProof>
...
export class AAPClient {
  ...
  verify(
    serverUrl?: string,
    solutionOrCallback?: string | LLMCallback | BatchLLMCallback,
