...
Push notifications are sent _in addition to_ the primary channel, not instead of it. If push delivery fails, the notification still goes to the primary channel.
